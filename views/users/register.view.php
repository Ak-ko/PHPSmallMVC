    ...
    <div class="flex min-h-full items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
      <div class="w-full max-w-md space-y-8">
        <div>
          ...
          <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Register To Get Access</h2>
        </div>
        ...
        <?php endif; ?>
        <p>
          Already have an account ? <a href="/login" class="text-blue-800 hover:underline">login</a>
        </p>
      </div>
    </div>
  </div>
